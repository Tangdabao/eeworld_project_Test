#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_uart.c"
/**
  ******************************************************************************
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_uart.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_uart.c"
...
void UART_DeInit(void)
{
  ((UART_Type *) 0x40300000UL)->TIMEOUT   = 0x000001FF;
  ((UART_Type *) 0x40300000UL)->LCRH_RX   = 0x00000000;
  ((UART_Type *) 0x40300000UL)->IBRD      = 0x00000000;
  ((UART_Type *) 0x40300000UL)->FBRD      = 0x00000000;
  ((UART_Type *) 0x40300000UL)->LCRH_TX   = 0x00000000;
  ((UART_Type *) 0x40300000UL)->CR        = 0x00040300;
  ((UART_Type *) 0x40300000UL)->IFLS      = 0x00000012;
  ((UART_Type *) 0x40300000UL)->IMSC      = 0x00000000;
  ((UART_Type *) 0x40300000UL)->ICR       = 0x00000000;
  ((UART_Type *) 0x40300000UL)->DMACR     = 0x00000000;
  ((UART_Type *) 0x40300000UL)->XFCR      = 0x00000000;
  ((UART_Type *) 0x40300000UL)->XON1      = 0x00000000;
  ((UART_Type *) 0x40300000UL)->XON2      = 0x00000000;
  ((UART_Type *) 0x40300000UL)->XOFF1     = 0x00000000;
  ((UART_Type *) 0x40300000UL)->XOFF2     = 0x00000000;
}
...
void UART_Init(UART_InitType* UART_InitStruct)
{
  ...
  divider = ((16000000)<<7) / (16 * UART_InitStruct->UART_BaudRate);
  
  ibrd = divider >> 7;
  ((UART_Type *) 0x40300000UL)->IBRD = ibrd;
  fbrd = ((divider - (ibrd <<7) + 1) >> 1);
  if (fbrd > 0x3f) {
    ibrd++;
    fbrd = (fbrd - 0x3F) & 0x3F;
  }
  ((UART_Type *) 0x40300000UL)->FBRD = fbrd;
  
  /*---------------------------- UART Word Length Configuration -----------------------*/
  ((UART_Type *) 0x40300000UL)->LCRH_TX_b.WLEN_TX = UART_InitStruct->UART_WordLengthTransmit;
  ((UART_Type *) 0x40300000UL)->LCRH_RX_b.WLEN_RX = UART_InitStruct->UART_WordLengthReceive;
  
  /*---------------------------- UART Stop Bits Configuration -----------------------*/
  ((UART_Type *) 0x40300000UL)->LCRH_TX_b.STP2_TX = UART_InitStruct->UART_StopBits;
  ((UART_Type *) 0x40300000UL)->LCRH_RX_b.STP2_RX = UART_InitStruct->UART_StopBits;
  
  /*---------------------------- UART Parity Configuration -----------------------*/
  if(UART_InitStruct->UART_Parity == ((uint8_t)0)) {
    ((UART_Type *) 0x40300000UL)->LCRH_TX_b.PEN_TX = RESET;
    ((UART_Type *) 0x40300000UL)->LCRH_RX_b.PEN_RX = RESET;
  }
  else if(UART_InitStruct->UART_Parity == ((uint8_t)2)) {
    ((UART_Type *) 0x40300000UL)->LCRH_TX_b.PEN_TX = SET;
    ((UART_Type *) 0x40300000UL)->LCRH_TX_b.EPS_TX = RESET;
    ((UART_Type *) 0x40300000UL)->LCRH_RX_b.PEN_RX = SET;
    ((UART_Type *) 0x40300000UL)->LCRH_RX_b.EPS_RX = RESET;
  }
  else {
    ((UART_Type *) 0x40300000UL)->LCRH_TX_b.PEN_TX = SET;
    ((UART_Type *) 0x40300000UL)->LCRH_TX_b.EPS_TX = SET;    
    ((UART_Type *) 0x40300000UL)->LCRH_RX_b.PEN_RX = SET;
    ((UART_Type *) 0x40300000UL)->LCRH_RX_b.EPS_RX = SET;    
  }

  /*---------------------------- UART Mode Configuration -----------------------*/
  ((UART_Type *) 0x40300000UL)->CR_b.RXE = UART_InitStruct->UART_Mode&1;
  ((UART_Type *) 0x40300000UL)->CR_b.TXE = (UART_InitStruct->UART_Mode>>1)&1;

  /*---------------------------- UART Hardware flow control Configuration -----------------------*/
  ((UART_Type *) 0x40300000UL)->CR_b.RTSEN = UART_InitStruct->UART_HardwareFlowControl&1;
  ((UART_Type *) 0x40300000UL)->CR_b.CTSEN = (UART_InitStruct->UART_HardwareFlowControl>>1)&1;

  /*---------------------------- UART Fifo Configuration -----------------------*/
  ((UART_Type *) 0x40300000UL)->LCRH_TX_b.FEN_TX = (uint8_t)UART_InitStruct->UART_FifoEnable;
  ((UART_Type *) 0x40300000UL)->LCRH_RX_b.FEN_RX = (uint8_t)UART_InitStruct->UART_FifoEnable;
...
void UART_StructInit(UART_InitType* UART_InitStruct)
{
  ...
  UART_InitStruct->UART_WordLengthTransmit = ((uint8_t)3);
  UART_InitStruct->UART_WordLengthReceive = ((uint8_t)3);
  UART_InitStruct->UART_StopBits = ((uint8_t)0);
  UART_InitStruct->UART_Parity = ((uint8_t)0);
  UART_InitStruct->UART_Mode = ((uint8_t)0x01) | ((uint8_t)0x02);
  UART_InitStruct->UART_HardwareFlowControl = ((uint8_t)0x00); 
...
void UART_ITConfig(uint16_t UART_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((((UART_Type *) 0x40300000UL)->IMSC) |= (UART_IT));
  }
  else {
...
void UART_SendData(uint16_t Data)
{
  ...
  /* Transmit Data */
  ((UART_Type *) 0x40300000UL)->DR = (Data & (uint16_t)0x01FF);
}
...
uint16_t UART_ReceiveData(void)
{
  ...
  /* Receive Data */
  return (uint16_t)(((UART_Type *) 0x40300000UL)->DR & 0x00FF);
}
...
void UART_BreakCmd(FunctionalState NewState)
{
  ...
  ((UART_Type *) 0x40300000UL)->LCRH_TX_b.BRK = (uint8_t)NewState;
}
...
void UART_RequestToSendCmd(FunctionalState NewState)
{
  ...
  ((UART_Type *) 0x40300000UL)->CR_b.RTS = (uint8_t)NewState;
}
...
FlagStatus UART_GetFlagStatus(uint32_t UART_FLAG)
{
  ...
  if (UART_FLAG & 0x80000000) {
    if (((UART_Type *) 0x40300000UL)->RSR & UART_FLAG) {
      return SET;
    }
    else {
      return RESET;
    ...
    if (((UART_Type *) 0x40300000UL)->FR & UART_FLAG) {
      return SET;
    }
    else {
      return RESET;
...
void UART_ClearFlag(uint32_t UART_FLAG)
{
  ...
  ((UART_Type *) 0x40300000UL)->ECR = UART_FLAG;
}
...
ITStatus UART_GetITStatus(uint16_t UART_IT)
{
  ...
  if ((((UART_Type *) 0x40300000UL)->RIS & UART_IT) != (uint16_t)RESET) {
    return SET;
  }
  else {
    return RESET;
...
void UART_ClearITPendingBit(uint16_t UART_IT)
{
  ...
  ((UART_Type *) 0x40300000UL)->ICR = UART_IT;
}
...
/**
  ...
  *   This parameter can be one of the following values:
  *   @arg FIFO_LEV_1_64: interrupt when Tx FIFO becomes <= 1/64 full 
  *   @arg FIFO_LEV_1_32: interrupt when Tx FIFO becomes <= 1/32 full 
  *   @arg FIFO_LEV_1_16: interrupt when Tx FIFO becomes <= 1/16 full 
  *   @arg FIFO_LEV_1_8: interrupt when Tx FIFO becomes <= 1/8 full 
  *   @arg FIFO_LEV_1_4: interrupt when Tx FIFO becomes <= 1/4 full
  *   @arg FIFO_LEV_1_2: interrupt when Tx FIFO becomes <= 1/2 full 
  *   @arg FIFO_LEV_3_4: interrupt when Tx FIFO becomes <= 3/4 full 
  * @retval None
  */
void UART_TxFifoIrqLevelConfig(uint8_t UART_TxFifo_Level)
{
  ...
  ((UART_Type *) 0x40300000UL)->IFLS_b.TXIFLSEL = UART_TxFifo_Level;
}
...
/**
  ...
  *   This parameter can be one of the following values:
  *   @arg FIFO_LEV_1_64: interrupt when Rx FIFO becomes >= 1/64 full 
  *   @arg FIFO_LEV_1_32: interrupt when Rx FIFO becomes >= 1/32 full 
  *   @arg FIFO_LEV_1_16: interrupt when Rx FIFO becomes >= 1/16 full 
  *   @arg FIFO_LEV_1_8: interrupt when Rx FIFO becomes >= 1/8 full 
  *   @arg FIFO_LEV_1_4: interrupt when Rx FIFO becomes >= 1/4 full
  *   @arg FIFO_LEV_1_2: interrupt when Rx FIFO becomes >= 1/2 full 
  *   @arg FIFO_LEV_3_4: interrupt when Rx FIFO becomes >= 3/4 full
  * @retval None
  */
void UART_RxFifoIrqLevelConfig(uint8_t UART_RxFifo_Level)
{
  ...
  ((UART_Type *) 0x40300000UL)->IFLS_b.RXIFLSEL = UART_RxFifo_Level;
}
...
/**
  ...
  *         UART_Timeout = timeout * OverSamplingFactor  * BaudRate
  *         Where OverSamplingFactor is 16 if OVSFACT == 0 and is 8 if OVSFACT == 1
  * @retval None
  */
void UART_TimeoutConfig(uint32_t UART_Timeout)
{
  ...
  ((UART_Type *) 0x40300000UL)->TIMEOUT = UART_Timeout;
}
...
void UART_DMACmd(uint8_t UART_DMAReq, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((UART_Type *) 0x40300000UL)->DMACR |= UART_DMAReq;
  }
  else
  {
    /* Disable the DMA transfer for selected requests by clearing the DMAT and/or
       DMAR bits in the UART CR3 register */
    ((UART_Type *) 0x40300000UL)->DMACR &= (uint8_t)~UART_DMAReq;
  }
}
...
void UART_SwFlowControl(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((UART_Type *) 0x40300000UL)->XFCR_b.SFEN = SET;
  }
  else {
    /* Disable UART software flow control */
    ((UART_Type *) 0x40300000UL)->XFCR_b.SFEN = RESET;
  }
}
...
void UART_RxSwFlowControlMode(uint8_t UART_RxSwFlowCtrlMode)
{
  ...
  ((UART_Type *) 0x40300000UL)->XFCR_b.SFRMOD = UART_RxSwFlowCtrlMode;
}
...
void UART_TxSwFlowControlMode(uint8_t UART_TxSwFlowCtrlMode)
{
  ...
  ((UART_Type *) 0x40300000UL)->XFCR_b.SFTMOD = UART_TxSwFlowCtrlMode;
}
...
void UART_XonAnyBit(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((UART_Type *) 0x40300000UL)->XFCR_b.XONANY = SET;
  }
  else {
    /* Disable the UART XON any bit */
    ((UART_Type *) 0x40300000UL)->XFCR_b.XONANY = RESET;
  }
}
...
void UART_SpecialCharDetect(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((UART_Type *) 0x40300000UL)->XFCR_b.SPECHAR = SET;
  }
  else {
    /* Disable the UART special character detection */
    ((UART_Type *) 0x40300000UL)->XFCR_b.SPECHAR = RESET;
  }
}
...
void UART_Xon1Char(uint8_t UART_XonChar)
{
  ...
  ((UART_Type *) 0x40300000UL)->XON1 = UART_XonChar;
}
...
void UART_Xon2Char(uint8_t UART_XonChar)
{
  ...
  ((UART_Type *) 0x40300000UL)->XON2 = UART_XonChar;
}
...
void UART_Xoff1Char(uint8_t UART_XoffChar)
{
  ...
  ((UART_Type *) 0x40300000UL)->XOFF1 = UART_XoffChar;
}
...
void UART_Xoff2Char(uint8_t UART_XoffChar)
{
  ...
  ((UART_Type *) 0x40300000UL)->XOFF2 = UART_XoffChar;
}
