#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\SDK_Eval_BlueNRG1\\src\\SDK_EVAL_Led.c"
/**
 * @file    SDK_EVAL_Led.c
...
/**
  * @}
  */
#line 30 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\SDK_Eval_BlueNRG1\\inc\\SDK_EVAL_Led.h"
...
#line 31 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\SDK_Eval_BlueNRG1\\inc\\SDK_EVAL_Led.h"
...
/******************* (C) COPYRIGHT 2015 STMicroelectronics *****END OF FILE****/
#line 26 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\SDK_Eval_BlueNRG1\\src\\SDK_EVAL_Led.c"
...
static uint32_t Get_LedGpioPin(SdkEvalLed xLed)
{
  ...
  {
    case(LED1):
      led_pin = s_vectnGpioPinVersion[SdkEvalGetVersion()-1][0];
      break;
    case(LED2):
      led_pin = s_vectnGpioPinVersion[SdkEvalGetVersion()-1][1];
      break;
    case(LED3):
      led_pin = s_vectnGpioPinVersion[SdkEvalGetVersion()-1][2];
      break;
    default:
      led_pin = s_vectnGpioPinVersion[SdkEvalGetVersion()-1][0];
      break;
...
void SdkEvalLedInit(SdkEvalLed xLed)
{
  ...
  GPIO_InitStructure.GPIO_Mode = ((uint8_t)6);
...
void SdkEvalLedOn(SdkEvalLed xLed)
{
   GPIO_WriteBit(Get_LedGpioPin(xLed), Bit_SET);
}
...
void SdkEvalLedOff(SdkEvalLed xLed)
{
   GPIO_WriteBit(Get_LedGpioPin(xLed), Bit_RESET);
}
