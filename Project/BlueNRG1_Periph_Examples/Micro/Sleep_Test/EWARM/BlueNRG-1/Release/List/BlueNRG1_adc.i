#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_adc.c"
/**
******************************************************************************
* @file    BlueNRG1_adc.c
...
/* Includes ------------------------------------------------------------------*/
#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_adc.h"
/**
  ******************************************************************************
  * @file    BlueNRG1_adc.h
  * @author  VMA Application Team
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_adc.h"
...
/** @defgroup ADC_Input_Definitions   Input Definitions
  * @{
  */
#line 106 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_adc.h"

#line 116 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_adc.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_adc.c"
...
* @{
*/
#line 58 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_adc.c"
...
float ADC_ConvertDifferentialVoltage(int16_t raw_value, uint8_t attenuation)
{
  float pga, divider = ((float)(16708.0));
  
  pga = (float)attenuation;
  
  if(((ADC_Type *) 0x40800000UL)->CONF_b.OSR == ((uint8_t)0x01) || ((ADC_Type *) 0x40800000UL)->CONF_b.OSR == ((uint8_t)0x00)) {
    divider = ((float)(19450.0));
  }

  return ((1 + pga) * (raw_value / divider) * ((float)(2.4)));
}
...
float ADC_ConvertSingleEndedVoltage(int16_t raw_value, uint8_t channel, uint8_t vRef, uint8_t attenuation)
{
  ...
  if(channel == ((uint8_t)0x02)) 
    return  ((1 + pga) * (vref + ((raw_value/divider) * ((float)(2.4)))));
  else
    return  ((1 + pga) * (vref - ((raw_value/divider) * ((float)(2.4)))));
}
...
{
  return (((float)(4.36)) * (ADC_ConvertSingleEndedVoltage(raw_value, ((uint8_t)0x01), ((uint8_t)0x02), ((uint8_t)0x00))));
}
...
float ADC_ConvertTemperatureSensor(int16_t raw_value, uint8_t vRef, uint8_t attenuation)
{
  return  ((((float)(401.0)) * (ADC_ConvertSingleEndedVoltage(raw_value, ((uint8_t)0x01), ((uint8_t)0x02), ((uint8_t)0x00)))) - ((float)(267.0)));
}
float ADC_ConvertTemperatureSensorFarenait(int16_t raw_value, uint8_t vRef, uint8_t attenuation)
{
  return  ((722.0 * (ADC_ConvertSingleEndedVoltage(raw_value, ((uint8_t)0x01), ((uint8_t)0x02), ((uint8_t)0x00)))) - 499.0);
}
...
void ADC_DeInit(void)
{
  ...
  ((ADC_Type *) 0x40800000UL)->CTRL_b.RESET = SET;
}
...
void ADC_StructInit(ADC_InitType* ADC_InitStruct)
{
  ...
  ADC_InitStruct->ADC_OSR = ((uint8_t)0x00);

  /* Select the input source */
  ADC_InitStruct->ADC_Input = ((uint8_t)0x00);

  /* Set the reference voltage */
  ADC_InitStruct->ADC_ReferenceVoltage = ((uint8_t)0x02);

  /* Set the conversion mode */
  ADC_InitStruct->ADC_ConversionMode = ((uint8_t)0x00);

  /* Set the attenuation */
  ADC_InitStruct->ADC_Attenuation = ((uint8_t)0x00);
}
...
void ADC_Init(ADC_InitType* ADC_InitStruct)               
{
  ...
  /* Set the decimation rate */
  ((ADC_Type *) 0x40800000UL)->CONF_b.OSR = ADC_InitStruct->ADC_OSR;
  
  /* Select the input source */
  if(ADC_InitStruct->ADC_Input == ((uint8_t)0x0F)) {
    ((ADC_Type *) 0x40800000UL)->CONF_b.MIC_SEL = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CONF_b.MIC_SEL = RESET;      
    ((ADC_Type *) 0x40800000UL)->CONF_b.CHSEL = ADC_InitStruct->ADC_Input;
  }
  
  /* Set the reference voltage */
  ((ADC_Type *) 0x40800000UL)->CONF_b.REFSEL = ADC_InitStruct->ADC_ReferenceVoltage;
  
  /* Set the conversion mode */
  if(ADC_InitStruct->ADC_ConversionMode == ((uint8_t)0x08)) {
    ((ADC_Type *) 0x40800000UL)->CONF_b.CONT = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CONF_b.CONT = RESET;
  }
  
  /* Set the attenuation */
  ((ADC_Type *) 0x40800000UL)->CONF_b.PGASEL = ADC_InitStruct->ADC_Attenuation;
...
void ADC_Cmd(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE) {
    if(((ADC_Type *) 0x40800000UL)->CONF_b.MIC_SEL) {
      ((ADC_Type *) 0x40800000UL)->CTRL_b.MIC_ON = SET;
    }
    ((ADC_Type *) 0x40800000UL)->CTRL_b.SWSTART = SET;
    ((ADC_Type *) 0x40800000UL)->CTRL_b.ON = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.ON = RESET;
    ((ADC_Type *) 0x40800000UL)->CTRL_b.STOP = SET;
  }
}
...
void ADC_DmaCmd(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE) {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.DMA_EN = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.DMA_EN = RESET;
  }
}
...
void ADC_Calibration(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE) {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.CALEN = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.RSTCALEN = SET;
    ((ADC_Type *) 0x40800000UL)->CTRL_b.CALEN = RESET;
  }
}
...
void ADC_AutoOffsetUpdate(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE) {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.AUTO_OFFSET = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.AUTO_OFFSET = RESET;
  }
}
...
void ADC_ThresholdCheck(FunctionalState NewState)
{
  ...
  if(NewState==ENABLE) {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.ENAB_COMP = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CTRL_b.ENAB_COMP = RESET;
  }
}
...
void ADC_ThresholdConfig(uint16_t ThresholdLow, uint16_t ThresholdHigh)
{
    ...
    ((ADC_Type *) 0x40800000UL)->THRESHOLD_HI = ThresholdHigh;
    ((ADC_Type *) 0x40800000UL)->THRESHOLD_LO = ThresholdLow;
}
...
void ADC_ConversionMode(uint8_t ConvertionMode)
{
  ...
  if(ConvertionMode==((uint8_t)0x08)) {
    ((ADC_Type *) 0x40800000UL)->CONF_b.CONT = SET;
  }
  else {
    ((ADC_Type *) 0x40800000UL)->CONF_b.CONT = RESET;
...
void ADC_SelectFrequencyMic(uint8_t Frequency)
{
  ...
  if(Frequency == ((uint8_t)0x00)) {
    ((ADC_Type *) 0x40800000UL)->CONF_b.DIG_FILT_CLK = RESET;
  }
  else if(Frequency == ((uint8_t)0x01)) {
    ((ADC_Type *) 0x40800000UL)->CONF_b.DIG_FILT_CLK = SET;
  }
...
FlagStatus ADC_GetFlagStatus(uint8_t ADC_Flag)
{
  ...
  if (((((ADC_Type *) 0x40800000UL)->SR_REG) & (ADC_Flag)) != (uint16_t)RESET) {
    /* SPI_FLAG is set */
    return SET;
  }
  else {
...
ITStatus ADC_GetITStatus(uint8_t ADC_Flag)
{
  ...
  if (((((ADC_Type *) 0x40800000UL)->IRQSTAT) & (ADC_Flag)) != (uint16_t)RESET) {
    /* ADC_Flag is set */
    return SET;
  }
  else {
...
void ADC_ITConfig(uint8_t ADC_Flag, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((((ADC_Type *) 0x40800000UL)->IRQMASK) &= ~(ADC_Flag));
  }
  else {
...
float ADC_GetConvertedData(uint8_t DataType, uint8_t Vref)
{
  ...
  raw_value = (int16_t)(uint16_t)((((((ADC_Type *) 0x40800000UL)->DATA_CONV))));
  pga_reg = ((ADC_Type *) 0x40800000UL)->CONF_b.PGASEL;
  
  if(DataType==((uint8_t)0x02)) {
    return ADC_ConvertSingleEndedVoltage(raw_value, (uint8_t)((uint8_t)0x02), Vref, pga_reg);
  }
  else if(DataType==((uint8_t)0x01)) {
    return ADC_ConvertSingleEndedVoltage(raw_value, (uint8_t)((uint8_t)0x01), Vref, pga_reg);
  }
  else if(DataType==((uint8_t)0x03) || DataType==((uint8_t)0x06) || DataType==((uint8_t)0x07)) {
    return ADC_ConvertDifferentialVoltage(raw_value, pga_reg);
  }
  else if(DataType==((uint8_t)0x05)) {
    return ADC_ConvertBatterySensor(raw_value, Vref);
  }
  else if(DataType==((uint8_t)0x04)) {
