#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_dma.c"
/**
  ******************************************************************************
  * @file    BlueNRG1_dma.c
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_dma.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_dma.c"
...
#line 65 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_dma.c"


#line 75 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_dma.c"
/**
* @}
*/
...
void DMA_DeInit(DMA_CH_Type* DMAy_Channelx)
{
  ...
  if (DMAy_Channelx == ((DMA_CH_Type *) 0xA000001CUL))
  {
    /* Reset interrupt pending bits for DMA Channel1 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x00000010) | ((uint32_t)0x00000020) | ((uint32_t)0x00000040) | ((uint32_t)0x00000080)))));
  }
  else if (DMAy_Channelx == ((DMA_CH_Type *) 0xA0000030UL))
  {
    /* Reset interrupt pending bits for DMA Channel2 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x00000400) | ((uint32_t)0x00000800)))));
  }
  else if (DMAy_Channelx == ((DMA_CH_Type *) 0xA0000044UL))
  {
    /* Reset interrupt pending bits for DMA Channel3 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x00001000) | ((uint32_t)0x00002000) | ((uint32_t)0x00004000) | ((uint32_t)0x00008000)))));
  }
  else if (DMAy_Channelx == ((DMA_CH_Type *) 0xA0000058UL))
  {
    /* Reset interrupt pending bits for DMA Channel4 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x00040000) | ((uint32_t)0x00080000)))));
  }
  else if (DMAy_Channelx == ((DMA_CH_Type *) 0xA000006CUL))
  {
    /* Reset interrupt pending bits for DMA Channel5 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x00100000) | ((uint32_t)0x00200000) | ((uint32_t)0x00400000) | ((uint32_t)0x00800000)))));
  }
  else if (DMAy_Channelx == ((DMA_CH_Type *) 0xA0000080UL))
  {
    /* Reset interrupt pending bits for DMA Channel6 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x01000000) | ((uint32_t)0x02000000) | ((uint32_t)0x04000000) | ((uint32_t)0x08000000)))));
  }
  else if (DMAy_Channelx == ((DMA_CH_Type *) 0xA0000094UL))
  {
    /* Reset interrupt pending bits for DMA Channel7 */
    ((((DMA_Type *) 0xA0000000UL)->IFCR) |= (((uint32_t)(((uint32_t)0x10000000) | ((uint32_t)0x20000000) | ((uint32_t)0x40000000) | ((uint32_t)0x80000000)))));    
  }
}
...
void DMA_SelectAdcChannel(uint8_t DMA_AdcChannel, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((((CKGEN_SOC_Type *) 0x40900000UL)->DMA_CONFIG) |= (DMA_AdcChannel));
  }
  else {
...
FlagStatus DMA_GetFlagStatus(uint32_t DMA_Flag)
{
  ...
  tmpreg = ((DMA_Type *) 0xA0000000UL)->ISR;
...
void DMA_ClearFlag(uint32_t DMA_Flag)
{
  ...
  ((DMA_Type *) 0xA0000000UL)->IFCR = DMA_Flag;
