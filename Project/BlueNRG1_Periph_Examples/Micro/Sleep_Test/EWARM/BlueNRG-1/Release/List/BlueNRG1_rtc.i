#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_rtc.c"
/**
  ******************************************************************************
  * @file    BlueNRG1_rtc.c
...
/* Includes ------------------------------------------------------------------*/
#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_rtc.h"
/**
  ******************************************************************************
  * @file    BlueNRG1_rtc.h
  * @author  VMA Application Team
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_rtc.h"
...
#line 130 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_rtc.h"

#line 138 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_rtc.h"

#line 146 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_rtc.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_rtc.c"
...
{  
  ...
  ((RTC_Type *) 0x40F00000UL)->TCR_b.OS = RTC_InitStruct->RTC_operatingMode;
  ((RTC_Type *) 0x40F00000UL)->TCR_b.SP = RTC_InitStruct->RTC_PATTERN_SIZE;

  ((RTC_Type *) 0x40F00000UL)->TLR1 = RTC_InitStruct->RTC_TLR1;
  ((RTC_Type *) 0x40F00000UL)->TLR2 = RTC_InitStruct->RTC_TLR2;
  ((RTC_Type *) 0x40F00000UL)->TPR1 = RTC_InitStruct->RTC_PATTERN1;
  ((RTC_Type *) 0x40F00000UL)->TPR2 = RTC_InitStruct->RTC_PATTERN2;
  ((RTC_Type *) 0x40F00000UL)->TPR3 = RTC_InitStruct->RTC_PATTERN3;
  ((RTC_Type *) 0x40F00000UL)->TPR4 = RTC_InitStruct->RTC_PATTERN4;
...
void RTC_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ((RTC_Type *) 0x40F00000UL)->TCR_b.EN = SET;
  }
  else {
    ((RTC_Type *) 0x40F00000UL)->TCR_b.EN = RESET;
...
void RTC_IT_Config(uint8_t RTC_IT, FunctionalState NewState)
{
  ...
  if (RTC_IT == ((uint8_t)1)) {
    ...
    ((RTC_Type *) 0x40F00000UL)->IMSC_b.WIMSC = NewState;
  }
  else {
    /* Disable the selected RTC interrupts */
    ((RTC_Type *) 0x40F00000UL)->IMSC_b.TIMSC = NewState;
  }
}
...
ITStatus RTC_IT_Status(uint8_t RTC_IT)
{
  ...
  if ((((RTC_Type *) 0x40F00000UL)->RIS & RTC_IT) != RESET) {
    /* RTC_IT is set */
    return SET;
  }
  else {
...
void RTC_IT_Clear(uint8_t RTC_IT)
{
  ...
  ((RTC_Type *) 0x40F00000UL)->ICR = RTC_IT;
}
...
void RTC_ClockwatchCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ((RTC_Type *) 0x40F00000UL)->CTCR_b.CWEN = SET;
  }
  else {
    ((RTC_Type *) 0x40F00000UL)->CTCR_b.CWEN = RESET;
  }
}
...
void RTC_SetTimeDate(RTC_DateTimeType* RTC_DateTime)
{
  ...
  ((RTC_Type *) 0x40F00000UL)->CWDLR_b.CWSECL = RTC_DateTime->Second;
  
  /** Select minutes from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDLR_b.CWMINL = RTC_DateTime->Minute;
  
  /** Select hours from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDLR_b.CWHOURL = RTC_DateTime->Hour;
  
  /** Select week day from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDLR_b.CWDAYWL = RTC_DateTime->WeekDay;
  
  /** Select month day from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDLR_b.CWDAYML = RTC_DateTime->MonthDay;
  
  /** Select month from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDLR_b.CWMONTHL = RTC_DateTime->Month;
  
  /* Store data to load register */
  ((RTC_Type *) 0x40F00000UL)->CWYLR_b.CWYEARL = RTC_DateTime->Year;
}
...
void RTC_SetMatchTimeDate(RTC_DateTimeType* RTC_MatchDataTime)
{
  ...
  /* Select seconds from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDMR_b.CWSECM = RTC_MatchDataTime->Second;
  
  /* Select minutes from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDMR_b.CWMINM = RTC_MatchDataTime->Minute;
  
  /* Select hours from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDMR_b.CWHOURM = RTC_MatchDataTime->Hour;
  
  /* Select week day from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDMR_b.CWDAYWM = RTC_MatchDataTime->WeekDay;
  
  /* Select month day from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDMR_b.CWDAYMM = RTC_MatchDataTime->MonthDay;
  
  /* Select month from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWDMR_b.CWMONTHM = RTC_MatchDataTime->Month;
  
/* Select year from the data structure */
  ((RTC_Type *) 0x40F00000UL)->CWYMR_b.CWYEARM = RTC_MatchDataTime->Year;
}
...
void RTC_GetTimeDate(RTC_DateTimeType* RTC_DataTime)
{
  ...
  RTC_DataTime->Second = ((RTC_Type *) 0x40F00000UL)->CWDR_b.CWSEC;
  
  /* Select minutes from the RTC register */
  RTC_DataTime->Minute= ((RTC_Type *) 0x40F00000UL)->CWDR_b.CWMIN;
  
  /* Select hours from the RTC register */
  RTC_DataTime->Hour= ((RTC_Type *) 0x40F00000UL)->CWDR_b.CWHOUR;
  
  /* Select week day from the RTC register */
  RTC_DataTime->WeekDay = ((RTC_Type *) 0x40F00000UL)->CWDR_b.CWDAYW;
  
  /* Select month day from the RTC register */
  RTC_DataTime->MonthDay = ((RTC_Type *) 0x40F00000UL)->CWDR_b.CWDAYM;
  
  /* Select month from the RTC register */
  RTC_DataTime->Month = ((RTC_Type *) 0x40F00000UL)->CWDR_b.CWMONTH;
  
  /* Select year from the RTC register */
  RTC_DataTime->Year = ((RTC_Type *) 0x40F00000UL)->CWYR_b.CWYEAR;
}
...
uint32_t RTC_GetTimerValue(void)
{
  ...
  return ((RTC_Type *) 0x40F00000UL)->TDR;
}
...
{
  /* Return the current Time Data Register */
  return ((RTC_Type *) 0x40F00000UL)->TIN;
}
...
void RTC_AutoStart(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ((RTC_Type *) 0x40F00000UL)->TCR_b.S = SET;
  }
  else {
    ((RTC_Type *) 0x40F00000UL)->TCR_b.S = RESET;
  }
}
...
void RTC_SelectTrimmedClock(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ((RTC_Type *) 0x40F00000UL)->TCR_b.CLK = SET;
  }
  else {
    ((RTC_Type *) 0x40F00000UL)->TCR_b.CLK = RESET;
  }
}
