...
void RTC_Configuration(void)
{
  ...
  RTC_Init_struct.RTC_PATTERN_SIZE = 8-1;                    /**< Pattern size set to 8 */
  RTC_Init_struct.RTC_TLR1 = RTC_PERIOD_1s;                  /**< Load register TLR1 set for 1s period */
  RTC_Init_struct.RTC_TLR2 = RTC_PERIOD_100ms;               /**< Load register TLR2 set for 100ms period */
  /** Generated RTC pattern is set to generate following:
   *  - 4 periods defined by TLR1 (1s)
   *  - 4 periods defined by TLR2 (100ms)
   *  - 2 periods defined by TLT1 (1s)
   *  - 6 periods defined by TLR2 (100ms)
   */
  RTC_Init_struct.RTC_PATTERN1 = 0xF2;                       /**< Generated RTC pattern 0b11110010 */
  RTC_Init_struct.RTC_PATTERN2 = 0;
  RTC_Init_struct.RTC_PATTERN3 = 0;
  RTC_Init_struct.RTC_PATTERN4 = 0;
