#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_pka.c"
/**
******************************************************************************
* @file    BlueNRG1_pka.c
...
/* Includes ------------------------------------------------------------------*/
#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_pka.h"
/**
  ******************************************************************************
  * @file    BlueNRG1_pka.h
  * @author  VMA Application Team
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_pka.h"
 ...
 */
#line 103 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_pka.h"

/* The initial Point Y coordinate of the curve in hex format:
 * 4fe342e2 fe1a7f9b 8ee7eb4a 7c0f9e16 2bce3357 6b315ece cbb64068 37bf51f5
 */
#line 115 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_pka.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_pka.c"
...
void PKA_Reset(void)
{
  ...
  ((PKA_Type *) 0xC0000000UL)->CSR_b.SFT_RST = SET;
  
  /* the Bit SFT_RST must be reset after set */
  ((PKA_Type *) 0xC0000000UL)->CSR_b.SFT_RST = RESET;
}
...
{ 
  /* Set Bit GO of CSR */
  ((PKA_Type *) 0xC0000000UL)->CSR_b.GO = SET;
  
  /* the Bit GO must be reset before the end of calculation */
  ((PKA_Type *) 0xC0000000UL)->CSR_b.GO = RESET;
...
void PKA_WaitProcess(void)
{
  ...
  while(((PKA_Type *) 0xC0000000UL)->CSR_b.READY != SET);
}
...
{
  /* Wait PKA processing end */
  return (FlagStatus)(((PKA_Type *) 0xC0000000UL)->CSR_b.READY);
}
...
{   
  ...
  errorCode = *(uint32_t *)(((0xC0000000UL + 0x00000400)));
...
void PKA_ITConfig(uint8_t PkaFlag, FunctionalState NewState)
{
  ...
  if (NewState == ENABLE) {
    ((((PKA_Type *) 0xC0000000UL)->IEN) |= (PkaFlag));
  }
...
void PKA_ClearITPendingBit(uint8_t PkaFlag)
{
  ...
  /* Clear the flags */
  ((PKA_Type *) 0xC0000000UL)->ISR = PkaFlag;
}
...
FlagStatus PKA_GetFlagStatus(uint8_t PkaFlag)
{
  ...
  if((((PKA_Type *) 0xC0000000UL)->ISR & PkaFlag) != (uint16_t)RESET) {
    return SET;
  }
  else {
    return RESET;
...
ErrorStatus PKA_SetData(uint8_t dataType, uint32_t* srcData)
{
  ...
  if (dataType == 0x01)
    StartAddress = ((0xC0000000UL + 0x00000400) + 0x6C);
  else if (dataType == 0x02)
    StartAddress = ((0xC0000000UL + 0x00000400) + 0x90);
  else if (dataType == 0x03)
    StartAddress = ((0xC0000000UL + 0x00000400) + 0xB4);
  else return ERROR;
