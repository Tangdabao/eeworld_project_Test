#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"
...
/**
  * @}
  */
#line 17 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"
...
#line 18 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"
...
/******************* (C) COPYRIGHT 2016 STMicroelectronics *****END OF FILE****/
#line 19 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"
...
__weak void NVM_Handler(void) {};
__weak void UART_Handler(void) {};
__weak void SPI_Handler(void) {};
__weak void Blue_Handler(void) {};
__weak void BATTERY_LOW_Handler(void) {};
__weak void ADV_Handler(void) {};
__weak void MFT1A_Handler(void) {};
__weak void MFT1B_Handler(void) {};
__weak void MFT2A_Handler(void) {};
__weak void MFT2B_Handler(void) {};
__weak void RTC_Handler(void) {};
__weak void WDG_Handler(void) {};
__weak void ADC_Handler(void) {};
__weak void I2C2_Handler(void) {};
__weak void I2C1_Handler(void) {};
__weak void DMA_Handler(void) {};
__weak void PKA_Handler(void) {};
...
//
//------------------------------------------------------------------------------
_Pragma("location=\".ota_sw_activation\"")
__no_init volatile uint32_t ota_sw_activation;
...
//------------------------------------------------------------------------------
_Pragma("location=\".savedMSP\"")
__root uint32_t savedMSP;
...
//------------------------------------------------------------------------------
_Pragma("location=\".wakeupFromSleepFlag\"")
__root uint8_t wakeupFromSleepFlag;
...
//
//------------------------------------------------------------------------------
_Pragma("location=\".__blueflag_RAM\"")
__root uint32_t __blueflag_RAM;
...
int __low_level_init(void) 
{
  ...
  if ((((CKGEN_SOC_Type *) 0x40900000UL)->REASON_RST == 0) && (((CKGEN_BLE_Type *) 0x48100000UL)->REASON_RST > 0x05)) {
...
#line 221 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"


_Pragma("location=\".intvec\"")
__root const intvec_elem __vector_table[] = {
    { . __ptr = __sfe( "CSTACK" ) },                            /* Stack address                      */
    __iar_program_start,           		    /* Reset handler is C initialization. */
    NMI_Handler,                            /* The NMI handler                    */ 
    HardFault_Handler,                      /* The hard fault handler             */ 
    (intfunc) (0xAA5555AA),            /* OTA Application                    */
    (intfunc) (0x424C5545),                /* Reserved for blue flag DTM updater */ 
    0x00000000,                             /* Reserved                           */ 
    0x00000000,                             /* Reserved                           */ 
    0x00000000,                             /* Reserved                           */ 
    0x00000000,                             /* Reserved                           */ 
...
//
//------------------------------------------------------------------------------
_Pragma("location=\".app_base\"")
__root uint32_t *app_base = (uint32_t *) __vector_table;


_Pragma("location=\".bss.__blue_RAM\"")
__root static uint8_t __blue_RAM[8*64+12] = {0,};
 ...
 */
#line 445 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"
...
void DeviceConfiguration(BOOL coldStart, BOOL waitLS_Ready)
{
  ...
  volatile uint8_t cold_start_config[] = { 0x02, 0x3F, 0x00, 0x02, 0x3E, 0x30, 0x02, 0x3C, 0x20, 0x02, 0x3B, 0x4C, 0x02, 0x3A, 0x40, 0x02, 0x39, 0xB2, 0x02, 0x34, 0x5B, 0x02, 0x35, 0x0B, 0x00 };
  ...
  if (coldStart) {    
    ...
    cold_start_config[11] = 0x4C;
    cold_start_config[8] = 0x20;
    cold_start_config[17] = 0xB2;
#line 501 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\CMSIS\\Device\\ST\\BlueNRG1\\Source\\system_bluenrg1.c"
    ...
    Trimm_config = *(volatile uint32_t*)0x100007E8;
    if ((Trimm_config >> 16) == 0xAA55)
      cold_start_config[23] = ((Trimm_config&0x7)<<4)|0x0B;
 
    /* Setup LDO1V2 trimming value in ATB1_ANA_ENG_REG  */
    Trimm_config = *(volatile uint32_t*)0x100007E4;
    if ((Trimm_config >> 16) == 0xAA55) {
    ...
    ((BLUE_CTRL_Type *) 0x48000000UL)->RADIO_CONFIG = 0x10000U | (uint16_t)((uint32_t)cold_start_config & 0x0000FFFFU);
    while ((((BLUE_CTRL_Type *) 0x48000000UL)->RADIO_CONFIG & 0x10000) != 0);
  }
  ...
  */
  while(((CKGEN_BLE_Type *) 0x48100000UL)->CLK32K_IT == 0);
  ((CKGEN_BLE_Type *) 0x48100000UL)->CLK32K_IT = 1;
  ((CKGEN_BLE_Type *) 0x48100000UL)->CLK32K_COUNT = 23; //Restore the window length for slow clock measurement.
...
void SystemInit(void)
{
  ...
  ((FLASH_Type *) 0x40100000UL)->CONFIG = 0x08;
  ...
  */
  ...
  NVIC_SetPriority(NVM_IRQn,       3);
  NVIC_SetPriority(UART_IRQn,      3);
  NVIC_SetPriority(SPI_IRQn,       3);
  NVIC_SetPriority(BLUE_CTRL_IRQn, 0);
  NVIC_SetPriority(WDG_IRQn,       3);
  NVIC_SetPriority(ADC_IRQn,       3);
  NVIC_SetPriority(I2C2_IRQn,      3);
  NVIC_SetPriority(I2C1_IRQn,      3);
  NVIC_SetPriority(MFT1A_IRQn,    3);
  NVIC_SetPriority(MFT1B_IRQn,    3);
  NVIC_SetPriority(MFT2A_IRQn,    3);
  NVIC_SetPriority(MFT2B_IRQn,    3);
  NVIC_SetPriority(RTC_IRQn,       3);
  NVIC_SetPriority(PKA_IRQn,       3);
  NVIC_SetPriority(DMA_IRQn,       3);

  /* Device Configuration */
  DeviceConfiguration(1, 1);
  /* Disable all the peripherals clock except NVM, SYSCTR, PKA and RNG */
  ((CKGEN_SOC_Type *) 0x40900000UL)->CLOCK_EN = 0xE0066;
  __enable_interrupt();
}
