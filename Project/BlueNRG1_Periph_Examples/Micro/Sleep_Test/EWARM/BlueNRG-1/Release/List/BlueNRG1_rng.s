...
//    List file    =  
//        D:\Program Files (x86)\STMicroelectronics\BlueNRG-1_2 DK
//        2.5.0\Project\BlueNRG1_Periph_Examples\Micro\Sleep_Test\EWARM\BlueNRG-1\Release\List\BlueNRG1_rng.s
//
///////////////////////////////////////////////////////////////////////////////
...
??RNG_Cmd_0:
        ...
        THUMB
RNG_GetFlagStatus:
        LDR      R0,??DataTable0  ;; 0xb0000004
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+31
        LSRS     R0,R0,#+31
        BEQ      ??RNG_GetFlagStatus_0
        MOVS     R0,#+1
??RNG_GetFlagStatus_0:
        BX       LR               ;; return
