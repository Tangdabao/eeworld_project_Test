#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_sysCtrl.c"
/**
  ******************************************************************************
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_sysCtrl.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_sysCtrl.c"
...
#line 60 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_sysCtrl.c"
...
void SysCtrl_DeInit(void)
{
  ((SYSTEM_CTRL_Type *) 0x40200000UL)->WKP_IO_IS  = 0x00;
  ((SYSTEM_CTRL_Type *) 0x40200000UL)->WKP_IO_IE  = 0x03;
  ((CKGEN_SOC_Type *) 0x40900000UL)->CONTROL      = 0x01FA03F0;
  ((CKGEN_SOC_Type *) 0x40900000UL)->CLOCK_EN     = 0x0003FFFF;
  ((CKGEN_BLE_Type *) 0x48100000UL)->CLK32K_COUNT = 0x0000000F;
  ((CKGEN_BLE_Type *) 0x48100000UL)->CLK32K_IT    = 0x00000000;
}
...
void SysCtrl_PeripheralClockCmd(uint32_t PeriphClock, FunctionalState NewState)
{
  ...
  if (NewState == ENABLE) {
    ((((CKGEN_SOC_Type *) 0x40900000UL)->CLOCK_EN) |= (PeriphClock));
  }
  else {
    ((((CKGEN_SOC_Type *) 0x40900000UL)->CLOCK_EN) &= ~(PeriphClock));
  }
...
RESET_REASON_Type SysCtrl_GetWakeupResetReason(void)
{
  ...
  tmpSoc = ((CKGEN_SOC_Type *) 0x40900000UL)->REASON_RST;
  tmpBle = ((CKGEN_BLE_Type *) 0x48100000UL)->REASON_RST;

  if ((tmpSoc == 0) &&
      (tmpBle >= (0x00000008 | (0x00000001))) && 
      (tmpBle <= (0x00000080 | (0x00000001)))) {
    if ((tmpBle & (0x00000008 | (0x00000001))) == (0x00000008 | (0x00000001))) {
      return RESET_BLE_WAKEUP_FROM_IO9;
    }
    if ((tmpBle & (0x00000010 | (0x00000001))) == (0x00000010 | (0x00000001))) {
      return RESET_BLE_WAKEUP_FROM_IO10;
    }
    if ((tmpBle & (0x00000020 | (0x00000001))) == (0x00000020 | (0x00000001))) {
      return RESET_BLE_WAKEUP_FROM_IO11;
    }
    if ((tmpBle & (0x00000040 | (0x00000001))) == (0x00000040 | (0x00000001))) {
      return RESET_BLE_WAKEUP_FROM_IO12;
    }
    if ((tmpBle & (0x00000080 | (0x00000001))) == (0x00000080 | (0x00000001))) {
      return RESET_BLE_WAKEUP_FROM_IO13;
    }
  }

  if ((tmpSoc == 0) &&
      ((tmpBle & (0x00000100 | (0x00000001))) == (0x00000100 | (0x00000001)))) {
    return RESET_BLE_WAKEUP_FROM_TIMER1;
  }
  if ((tmpSoc == 0) &&
      ((tmpBle & (0x00000400 | (0x00000001))) == (0x00000400 | (0x00000001)))) {
    return RESET_BLE_WAKEUP_FROM_TIMER2;
  }
  if ((tmpSoc == 0) &&
      ((tmpBle & (0x00000004 | (0x00000001))) == (0x00000004 | (0x00000001)))) {
    return RESET_BLE_POR;
  }
  if ((tmpSoc == 0) &&
      ((tmpBle & (0x00000002 | (0x00000001))) == (0x00000002 | (0x00000001)))) {
    return RESET_BLE_BOR;
  }
  if (tmpSoc == (0x00000002)) {
    return RESET_SYSREQ;
  }
  if (tmpSoc == (0x00000004)) {
    return RESET_WDG;
  }
  if((tmpSoc == (0x00000008))) {
    return RESET_LOCKUP;
  }
...
void SysCtrl_WakeupFromIo(uint8_t IO, uint8_t LevelState, FunctionalState NewState)
{
  ...
  if(LevelState == ((uint8_t)0)) {
    ((((SYSTEM_CTRL_Type *) 0x40200000UL)->WKP_IO_IS) |= (IO));
  }
  else {
    ((((SYSTEM_CTRL_Type *) 0x40200000UL)->WKP_IO_IS) &= ~(IO));
  }
  ...
  if(NewState == ENABLE) {
    ((((SYSTEM_CTRL_Type *) 0x40200000UL)->WKP_IO_IE) |= (IO));
  }
  else {    
    ((((SYSTEM_CTRL_Type *) 0x40200000UL)->WKP_IO_IE) &= ~(IO));
  }
...
{  
  ...
  if(XOFreq == ((uint8_t)1)) {
    ((SYSTEM_CTRL_Type *) 0x40200000UL)->CTRL_b.MHZ32_SEL = SET;
  }
  else if(XOFreq == ((uint8_t)0)) {   
    ((SYSTEM_CTRL_Type *) 0x40200000UL)->CTRL_b.MHZ32_SEL = RESET;
  }
}
