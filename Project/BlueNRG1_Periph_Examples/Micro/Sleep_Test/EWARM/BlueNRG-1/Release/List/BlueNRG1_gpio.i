#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
/**
******************************************************************************
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_gpio.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
...
void GPIO_DeInit(void)
{
  ...
  ((GPIO_Type *) 0x40000000UL)->OEN   = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->PE    = 0x03FFFFFF;
  ((GPIO_Type *) 0x40000000UL)->DS    = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->IS    = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->IBE   = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->IEV   = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->IE    = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->IC    = 0xFFFFFFFF;
  ((GPIO_Type *) 0x40000000UL)->MODE0 = 0x00000000;
  ((GPIO_Type *) 0x40000000UL)->MODE1 = 0x00000110;
  ((GPIO_Type *) 0x40000000UL)->MFTX  = 0x00000000;
}
...
void GPIO_Init(GPIO_InitType* GPIO_InitStruct)
{
  ...
  if(GPIO_InitStruct->GPIO_Mode == ((uint8_t)0)) {
    ((((GPIO_Type *) 0x40000000UL)->OEN) &= ~(GPIO_InitStruct->GPIO_Pin));
#line 141 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
  }
  else if(GPIO_InitStruct->GPIO_Mode == ((uint8_t)6)) {
    GPIO_InitStruct->GPIO_Mode = ((uint8_t)0);
    ((((GPIO_Type *) 0x40000000UL)->OEN) |= (GPIO_InitStruct->GPIO_Pin));
#line 152 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
  }
  ...
  for(uint8_t i = 0; i < (26); i++) {
    ...
    if(tmp!=0) {
      ...
      if(i < 8) {
        (((((GPIO_Type *) 0x40000000UL)->MODE0)) = ((((((((GPIO_Type *) 0x40000000UL)->MODE0))) & (~((0xF<<(i*4))))) | ((GPIO_InitStruct->GPIO_Mode << (i*4))))));
      }
      else if((i > 7) && (i < 16)) {
        (((((GPIO_Type *) 0x40000000UL)->MODE1)) = ((((((((GPIO_Type *) 0x40000000UL)->MODE1))) & (~((0xF<<((i-8)*4))))) | ((GPIO_InitStruct->GPIO_Mode << ((i-8)*4))))));
      }
#line 172 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
    }
  }

  /* Set the current mode */
  if(GPIO_InitStruct->GPIO_HighPwr == ENABLE) {
    ((((GPIO_Type *) 0x40000000UL)->DS) |= (GPIO_InitStruct->GPIO_Pin));
#line 185 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
  }
  else {
    ((((GPIO_Type *) 0x40000000UL)->DS) &= ~(GPIO_InitStruct->GPIO_Pin));
#line 195 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
  }

  /* Set the pull on IO */
  if(GPIO_InitStruct->GPIO_Pull == ENABLE) {
    ((((GPIO_Type *) 0x40000000UL)->PE) |= (GPIO_InitStruct->GPIO_Pin));
#line 207 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
  }
  else {
    ((((GPIO_Type *) 0x40000000UL)->PE) &= ~(GPIO_InitStruct->GPIO_Pin));
#line 217 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
  }
...
{
#line 262 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_gpio.c"
}
...
BitAction GPIO_ReadBit(uint32_t GPIO_Pin)
{
  ...
  if(((((GPIO_Type *) 0x40000000UL)->DATA) & (GPIO_Pin))) {
    return Bit_SET;
  }
  else {
    return Bit_RESET;
...
void GPIO_SetBits(uint32_t GPIO_Pins)
{
  ...
  ((((GPIO_Type *) 0x40000000UL)->DATS) = (GPIO_Pins));
}
...
void GPIO_ResetBits(uint32_t GPIO_Pins)
{
  ...
  ((((GPIO_Type *) 0x40000000UL)->DATC) = (GPIO_Pins));
}
...
{  
  ...
  ((GPIO_Type *) 0x40000000UL)->DATA ^= GPIO_Pins;
}
...
void GPIO_EXTIStructInit(GPIO_EXTIConfigType* GPIO_EXTIInitStruct)
{
  ...
  GPIO_EXTIInitStruct->GPIO_IrqSense = (0);
  GPIO_EXTIInitStruct->GPIO_Event = (0);
}
...
void GPIO_EXTIConfig(GPIO_EXTIConfigType* EXTIConfig)
{
  ...
  if (EXTIConfig->GPIO_IrqSense == (1)) {
    /* Configure level detection */
    ((((GPIO_Type *) 0x40000000UL)->IS) |= (EXTIConfig->GPIO_Pin));
  }
  else {
  ...
  /* Configure event */
  if (EXTIConfig->GPIO_Event == (1)) {
    /* Configure interrupt on high level or rising edge event */
    ((((GPIO_Type *) 0x40000000UL)->IEV) |= (EXTIConfig->GPIO_Pin));
    ((((GPIO_Type *) 0x40000000UL)->IBE) &= ~(EXTIConfig->GPIO_Pin));
  }
  else if (EXTIConfig->GPIO_Event == (0)) {
...
void GPIO_EXTICmd(uint32_t GPIO_Pins, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ((((GPIO_Type *) 0x40000000UL)->IE) |= (GPIO_Pins));
  }
  else {
    ((((GPIO_Type *) 0x40000000UL)->IE) &= ~(GPIO_Pins));
  }
...
void GPIO_ClearITPendingBit(uint32_t GPIO_Pins)
{
  ...
  ((((GPIO_Type *) 0x40000000UL)->IC) |= (GPIO_Pins));
}
...
{  
  ...
  if(((((GPIO_Type *) 0x40000000UL)->MIS) & (GPIO_Pin)) != (uint32_t)RESET) {
    return SET;
  }
  else {
    return RESET;
