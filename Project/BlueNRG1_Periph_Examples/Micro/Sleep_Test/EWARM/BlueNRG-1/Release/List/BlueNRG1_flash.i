#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_flash.c"
/**
******************************************************************************
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_flash.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_flash.c"
...
void FLASH_ErasePage(uint16_t PageNumber)
{
  ...
  pageAddress = (PageNumber * ((2048)))>>2;
  
  /* Clear IRQ */
  ((FLASH_Type *) 0x40100000UL)->IRQSTAT = 0x3F;
  
  /* Write the page address */
  ((FLASH_Type *) 0x40100000UL)->ADDRESS = pageAddress;
  
  /* Write the ERASE command */
  ((FLASH_Type *) 0x40100000UL)->COMMAND = 0x11;
...
void FLASH_EraseAllFlash(void)
{
  ...
  ((FLASH_Type *) 0x40100000UL)->COMMAND = 0x22;
...
void FLASH_ProgramWord(uint32_t Address, uint32_t Data)
{
  ...
  /* Write the page address */
  ((FLASH_Type *) 0x40100000UL)->ADDRESS = Address>>2;
  
  /* Write the data to program */
  ((FLASH_Type *) 0x40100000UL)->DATA0 = Data;
  
  /* Write the WRITE command */
  ((FLASH_Type *) 0x40100000UL)->COMMAND = 0x33;
...
void FLASH_ProgramWordBurst(uint32_t Address, uint32_t* Data)
{
  ...
  /* Write the data to program */
  ((FLASH_Type *) 0x40100000UL)->DATA0 = Data[0];
  ((FLASH_Type *) 0x40100000UL)->DATA1 = Data[1];
  ((FLASH_Type *) 0x40100000UL)->DATA2 = Data[2];
  ((FLASH_Type *) 0x40100000UL)->DATA3 = Data[3];
  
  /* Write the BURSTWRITE command */
  ((FLASH_Type *) 0x40100000UL)->COMMAND = 0xCC;
...
void FLASH_WaitCmdDone(void)
{
  ...
  while(((FLASH_Type *) 0x40100000UL)->IRQRAW_b.CMDDONE != SET);
}
...
void FLASH_ClearCmdDone(void)
{
  ...
  ((((FLASH_Type *) 0x40100000UL)->IRQSTAT) |= (0x01));
}
...
uint16_t FLASH_NextFreeFlashAddress(void)
{
  return ((FLASH_Type *) 0x40100000UL)->SIZE;
}
...
void FLASH_ITConfig(uint8_t FlashFlag, FunctionalState NewState)
{
  ...
  if (NewState == ENABLE) {
    ((((FLASH_Type *) 0x40100000UL)->IRQMASK) |= (FlashFlag));
  }
...
void FLASH_ClearITPendingBit(uint8_t FlashFlag)
{
  ...
  /* Clear the flags */
  ((FLASH_Type *) 0x40100000UL)->IRQSTAT = FlashFlag;
}
...
FlagStatus FLASH_GetFlagStatus(uint8_t FlashFlag)
{
  ...
  if((((FLASH_Type *) 0x40100000UL)->IRQRAW & FlashFlag) != (uint16_t)RESET) {
    return SET;
  }
  else {
    return RESET;
