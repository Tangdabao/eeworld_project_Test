#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"
/**
******************************************************************************
* @file    hw_config.c
...
/**
  * @}
  */
#line 25 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"
...
#line 26 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"
...
/******************* (C) COPYRIGHT 2014 STMicroelectronics *****END OF FILE****/
#line 27 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"
...
/******************* (C) COPYRIGHT 2015 STMicroelectronics *****END OF FILE****/
#line 28 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"
...
void GPIO_Configuration(void)
{
  ...
  SysCtrl_PeripheralClockCmd(((uint32_t)0x00000001), ENABLE);
  
  /** Init Structure */
  GPIO_StructInit(&GPIO_InitStructure);

  /** Configure GPIO_Pin_8 and GPIO_Pin_11 as UART_TXD and UART_RXD*/
  GPIO_InitStructure.GPIO_Pin = ((uint32_t)0x00000100) | ((uint32_t)0x00000800);
  GPIO_InitStructure.GPIO_Mode = ((uint8_t)1);
...
void UART_Configuration(void)
{
  ...
  /** Enable UART clock */
  SysCtrl_PeripheralClockCmd(((uint32_t)0x00000008), ENABLE);
  ...
  UART_InitStructure.UART_WordLengthTransmit = ((uint8_t)3);
  UART_InitStructure.UART_WordLengthReceive = ((uint8_t)3);
  UART_InitStructure.UART_StopBits = ((uint8_t)0);
  UART_InitStructure.UART_Parity = ((uint8_t)0);
  UART_InitStructure.UART_HardwareFlowControl = ((uint8_t)0x00);
  UART_InitStructure.UART_Mode = ((uint8_t)0x01) | ((uint8_t)0x02);
...
void PUSH1_EXT_IO_Config(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = ((uint32_t)0x00002000);
  GPIO_InitStructure.GPIO_Mode = ((uint8_t)0);
  GPIO_InitStructure.GPIO_Pull = DISABLE;
  GPIO_InitStructure.GPIO_HighPwr = DISABLE;
  ...
  exti_config.GPIO_Pin = ((uint32_t)0x00002000);
  exti_config.GPIO_IrqSense = (0);
  exti_config.GPIO_Event = (1);
  GPIO_EXTIConfig(&exti_config);

  GPIO_EXTICmd(((uint32_t)0x00002000), ENABLE);
...
{
  UART_SendData(data);
  while(UART_GetFlagStatus(((uint32_t)0x00000080)) == RESET) {}
  while(UART_GetFlagStatus(((uint32_t)0x00000008)) == SET) {}
}

#line 1 "D:\\Software\\IAR_BlueNRG\\arm\\inc\\c\\yfuns.h"
...
#line 11 "D:\\Software\\IAR_BlueNRG\\arm\\inc\\c\\yfuns.h"
...
#line 188 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"
...
#line 234 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\hw_config.c"

uint8_t noBlockingRead(uint8_t *c)
{
  uint8_t len=0;
  
  if (UART_GetFlagStatus(((uint32_t)0x00000040)) == SET) { // RX data received
