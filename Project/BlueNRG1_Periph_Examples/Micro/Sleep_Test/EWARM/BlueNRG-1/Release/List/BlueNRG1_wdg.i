#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_wdg.c"
/**
  ******************************************************************************
  * @file    BlueNRG1_WDG.c
...
/* Includes ------------------------------------------------------------------*/
#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_wdg.h"
/**
  ******************************************************************************
  * @file    BlueNRG1_WDG.h
  * @author  VMA Application Team
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_wdg.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_wdg.c"
...
void WDG_SetWriteAccess(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ((WDG_Type *) 0x40700000UL)->LOCK = ((uint32_t)0x1ACCE551);
  }
  else {
    ((WDG_Type *) 0x40700000UL)->LOCK = ((uint32_t)0x00000000);
  }
}
...
FunctionalState WDG_GetWriteAccess(void)
{
  return (FunctionalState)!((WDG_Type *) 0x40700000UL)->LOCK;
...
void WDG_SetReload(uint32_t WDG_Reload)
{
  /* Check the parameters */
  ((void)0);
  ((WDG_Type *) 0x40700000UL)->LR = WDG_Reload;
}
...
void WDG_Enable(void)
{
  ((WDG_Type *) 0x40700000UL)->CR_b.INTEN = SET;
  ((WDG_Type *) 0x40700000UL)->CR_b.RESEN = SET;
}
...
uint32_t WDG_GetCounter(void)
{
  return ((WDG_Type *) 0x40700000UL)->VAL;
}
...
void WDG_ITConfig(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((WDG_Type *) 0x40700000UL)->CR_b.INTEN = RESET;
  }
}
...
ITStatus WDG_GetITStatus(void)
{
  ...
  if (((WDG_Type *) 0x40700000UL)->RIS != (uint32_t)RESET) {
    bitstatus = SET;
  }
...
void WDG_ClearITPendingBit(void)
{
  ((WDG_Type *) 0x40700000UL)->ICR = 0xFFFFFFFF;
}
