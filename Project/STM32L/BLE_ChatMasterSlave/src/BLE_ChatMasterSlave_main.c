...
#if 0  
  //EN BOOT///
  BNRG_SPI_BOOT_CLK_ENABLE();
  GPIO_InitStruct.Pin = BNRG_SPI_BOOT_PIN;
  GPIO_InitStruct.Mode = BNRG_SPI_BOOT_MODE;
  GPIO_InitStruct.Pull = BNRG_SPI_BOOT_PULL;
  GPIO_InitStruct.Speed = BNRG_SPI_BOOT_SPEED;
  //GPIO_InitStruct.Alternate = BNRG_SPI_BOOT_PORT;
  HAL_GPIO_Init(BNRG_SPI_BOOT_PORT, &GPIO_InitStruct); 
  HAL_GPIO_WritePin(BNRG_SPI_BOOT_PORT, BNRG_SPI_BOOT_PIN, GPIO_PIN_RESET);
  while(1);
#endif
