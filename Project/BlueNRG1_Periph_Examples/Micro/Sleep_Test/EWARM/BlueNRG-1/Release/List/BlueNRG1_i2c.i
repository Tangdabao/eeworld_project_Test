#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_i2c.c"
/**
  ******************************************************************************
  * @file    BlueNRG1_i2c.c
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_i2c.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_i2c.c"
...
/** @defgroup I2C_Private_Variables Private Variables
  * @{
  */
static volatile const uint16_t Foncycles[4] = {1, 3, 4, 6};
...
void I2C_Init(I2C_Type* I2Cx, I2C_InitType* I2C_InitStruct)
{
  ...
  brcnt = (16000000) - I2C_InitStruct->I2C_ClockSpeed * foncycle;
  ...
  /* Set I2C own address */
  (((I2Cx->SCR)) = ((((((I2Cx->SCR))) & (~((0x03FF)))) | (I2C_InitStruct->I2C_OwnAddress1))));
...
void I2C_StructInit(I2C_InitType* I2C_InitStruct)
{
  ...
  I2C_InitStruct->I2C_OperatingMode = (0x00);

  /* initialize the I2C_Filtering member */
  I2C_InitStruct->I2C_Filtering = ((uint8_t)0x00);
...
ITStatus I2C_GetITStatus(I2C_Type* I2Cx, uint32_t I2C_IT)
{
  ...
  if (((I2Cx->RISR) & (I2C_IT)) != (uint32_t)RESET) {
    /* I2C_IT is set */
    return SET;
  }
  else {
...
ITStatus I2C_GetITPendingBit(I2C_Type* I2Cx, uint32_t I2C_IT)
{
  ...
  /* Check the status of the specified I2C flag */
  if (((I2Cx->MISR) & (I2C_IT)) != (uint32_t)RESET) {
    /* I2C_IT is set */
    return SET;
  }
  else {
