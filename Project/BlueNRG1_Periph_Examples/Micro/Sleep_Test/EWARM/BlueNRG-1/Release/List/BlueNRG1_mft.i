#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_mft.c"
/**
  ******************************************************************************
  * @file    BlueNRG1_MFT.c
...
/* Includes ------------------------------------------------------------------*/
#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_mft.h"
/**
  ******************************************************************************
  * @file    BlueNRG1_mft.h
  * @author  VMA Application Team
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_mft.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_mft.c"
...
void MFT_Init(MFT_Type* MFTx, MFT_InitType* MFT_InitStruct)
{
  ...
  MFTx->TNCKC_b.TNC1CSEL = ((uint8_t)0x00);
  MFTx->TNCKC_b.TNC2CSEL = ((uint8_t)0x00);
  
  if(MFT_InitStruct->MFT_Mode == ((uint8_t)0x80)) {
    MFTx->TNMCTRL_b.TNMDSEL = ((uint8_t)0x00);
...
void MFT_StructInit(MFT_InitType* MFT_InitStruct)
{
  ...
  MFT_InitStruct->MFT_Clock1 = ((uint8_t)0x00);
  MFT_InitStruct->MFT_Clock2 = ((uint8_t)0x00);
  MFT_InitStruct->MFT_CRA = 0;
  MFT_InitStruct->MFT_CRB = 0;
  MFT_InitStruct->MFT_Mode = ((uint8_t)0x00);
...
void MFT_SelectCapturePin( uint32_t MFT_TimerType, uint8_t MFT_Pin)
{
  ...
  /* set counter */
  if(MFT_TimerType == ((uint32_t)0x0)) {
    ((GPIO_Type *) 0x40000000UL)->MFTX_b.MFT1_TIMER_A = MFT_Pin;
  }
  else if(MFT_TimerType == ((uint32_t)0x1)) {
    ((GPIO_Type *) 0x40000000UL)->MFTX_b.MFT1_TIMER_B = MFT_Pin;
  }
  else if(MFT_TimerType == ((uint32_t)0x2)) {
    ((GPIO_Type *) 0x40000000UL)->MFTX_b.MFT2_TIMER_A = MFT_Pin;
  }
  else if(MFT_TimerType == ((uint32_t)0x3)) {
    ((GPIO_Type *) 0x40000000UL)->MFTX_b.MFT2_TIMER_B = MFT_Pin;
  }
