#line 1 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_spi.c"
/**
******************************************************************************
* @file    BlueNRG1_spi.c
...
/**
  * @}
  */
#line 33 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Project\\BlueNRG1_Periph_Examples\\Micro\\Sleep_Test\\EWARM\\BlueNRG-1\\..\\..\\..\\..\\..\\..\\Library\\BlueNRG1_Periph_Driver\\inc\\BlueNRG1_spi.h"
...
#line 24 "D:\\Program Files (x86)\\STMicroelectronics\\BlueNRG-1_2 DK 2.5.0\\Library\\BlueNRG1_Periph_Driver\\src\\BlueNRG1_spi.c"
...
void SPI_SetBaudrate(uint32_t Baudrate)
{
  ...
  /* set dividers */
  ((SPI_Type *) 0x40400000UL)->CPSR = cpsr;
  ((SPI_Type *) 0x40400000UL)->CR0_b.SCR = scr;    
}
...
void SPI_DeInit(void)
{
  ((SPI_Type *) 0x40400000UL)->CR0   = 0x1C000000;
  ((SPI_Type *) 0x40400000UL)->CR1   = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->CPSR  = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->IMSC  = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->ICR   = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->DMACR = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->RXFRM = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->CHN   = 0x00000000;
  ((SPI_Type *) 0x40400000UL)->WDTXF = 0x00000000;
}
...
void SPI_Init(SPI_InitType* SPI_InitStruct)
{
  ...
  /* Set SPI mode */
  ((SPI_Type *) 0x40400000UL)->CR1_b.MS = SPI_InitStruct->SPI_Mode;
  
  /* Set CPOL */
  ((SPI_Type *) 0x40400000UL)->CR0_b.SPO = SPI_InitStruct->SPI_CPOL;
  
  /* Set CPHA */
  ((SPI_Type *) 0x40400000UL)->CR0_b.SPH = SPI_InitStruct->SPI_CPHA;
  
  /* Set datasize */
  ((SPI_Type *) 0x40400000UL)->CR0_b.DSS = SPI_InitStruct->SPI_DataSize;
}
...
void SPI_StructInit(SPI_InitType* SPI_InitStruct)
{
  ...
  SPI_InitStruct->SPI_Mode = ((uint8_t)0x01);
  
  /* Initialize the SPI_DataSize member */
  SPI_InitStruct->SPI_DataSize = ((uint8_t)0x07);
  
  /* Initialize the SPI_CPOL member */
  SPI_InitStruct->SPI_CPOL = ((uint8_t)0);
  
  /* Initialize the SPI_CPHA member */
  SPI_InitStruct->SPI_CPHA = ((uint8_t)0);
...
void SPI_Cmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((SPI_Type *) 0x40400000UL)->CR1_b.SSE = SET;
  }
  else {
    /* Disable the selected SPI peripheral */
    ((SPI_Type *) 0x40400000UL)->CR1_b.SSE = RESET;
  }
}
...
void SPI_ITConfig(uint8_t SPI_IT, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((((SPI_Type *) 0x40400000UL)->IMSC) |= (SPI_IT));
  }
  else {
...
void SPI_SlaveModeOutputCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    /* Enable the output */
    ((SPI_Type *) 0x40400000UL)->CR1_b.SOD = RESET;
  }
  else {
    /* Disable the output */
    ((SPI_Type *) 0x40400000UL)->CR1_b.SOD = SET;
  }
}
...
uint32_t SPI_ReceiveData(void)
{
  ...
  return ((SPI_Type *) 0x40400000UL)->DR;
}
...
void SPI_DataSizeConfig(uint16_t SPI_DataSize)
{
  ...
  /* set the datasize */  
  ((SPI_Type *) 0x40400000UL)->CR0_b.DSS = SPI_DataSize;
}
...
void SPI_CommandSizeConfig(uint16_t SPI_DataSize)
{
  ...
  /* set the datasize */  
  ((SPI_Type *) 0x40400000UL)->CR0_b.CSS = SPI_DataSize;
}
...
void SPI_EnableWaitState(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    ...
    ((SPI_Type *) 0x40400000UL)->CR1_b.MSPIWAIT = RESET;
  }
  else {
    /* Disable the wait state  */
    ((SPI_Type *) 0x40400000UL)->CR1_b.MSPIWAIT = SET;
  }
}
...
void SPI_FrameFormatConfig(uint8_t SPI_FrameFormat)
{
  ...
  /* set the datasize */  
  ((SPI_Type *) 0x40400000UL)->CR0_b.FRF = SPI_FrameFormat;
}
...
FlagStatus SPI_GetFlagStatus(uint16_t SPI_FLAG)
{
  ...
  if (((((SPI_Type *) 0x40400000UL)->SR) & (SPI_FLAG)) != (uint16_t)RESET) {
    /* SPI_FLAG is set */
    return SET;
  }
  else {
...
ITStatus SPI_GetITStatus(uint8_t SPI_IT)
{
  ...
  if (((((SPI_Type *) 0x40400000UL)->RIS) & (SPI_IT)) != (uint16_t)RESET) {
    /* SPI_IT is set */
    return SET;
  }
  else {
...
void SPI_ClearITPendingBit(uint8_t SPI_IT)
{
  ...
  ((((SPI_Type *) 0x40400000UL)->ICR) &= ~(SPI_IT));
}
...
void SPI_ClearRXFIFO(void)
{
  ...
  while(SET == SPI_GetFlagStatus(((uint8_t)0x04)) ) {
    SPI_ReceiveData();
  }	
}
...
void SPI_ClearTXFIFO(void)
{
  ...
  ((SPI_Type *) 0x40400000UL)->ITCR_b.SWAPFIFO = SET;
  
  /* Flush the data from the TX FIFO till it is not empty. */
  while(0 == ((SPI_Type *) 0x40400000UL)->SR_b.TFE) {
    tmp |= ((SPI_Type *) 0x40400000UL)->TDR;
  }
  
  /* Disable the read from the TX FIFO */
  ((SPI_Type *) 0x40400000UL)->ITCR_b.SWAPFIFO = RESET;
...
void SPI_SetMasterCommunicationMode(uint32_t Mode)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CR0_b.SPIM = Mode;
}
...
void SPI_SetDummyCharacter(uint32_t NullCharacter)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CHN = NullCharacter;
}
...
void SPI_SetNumFramesToReceive(uint16_t Number)
{
  ...
  ((SPI_Type *) 0x40400000UL)->RXFRM = Number;
}
...
void SPI_SetNumFramesToTransmit(uint16_t Number)
{
  ...
  ((SPI_Type *) 0x40400000UL)->WDTXF = Number;
}
...
void SPI_SlaveSwSelection(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    /* Enable the output */
    ((SPI_Type *) 0x40400000UL)->CR0_b.CS1 = RESET;
  }
  else {
    /* Disable the output */
    ((SPI_Type *) 0x40400000UL)->CR0_b.CS1 = SET;
  }
}
...
void SPI_EndianFormatReception(uint8_t Endian)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CR1_b.RENDN = Endian;
}
...
void SPI_EndianFormatTransmission(uint8_t Endian)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CR1_b.TENDN = Endian;
}
...
void SPI_DelayBetweenFrames(uint8_t Delay)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CR1_b.MSPIWAIT = Delay;
}
...
void SPI_DelayDataInput(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE) {
    /* Enable the output */
    ((SPI_Type *) 0x40400000UL)->CR1_b.DATAINDEL = RESET;
  }
  else {
    /* Disable the output */
    ((SPI_Type *) 0x40400000UL)->CR1_b.DATAINDEL = SET;
  }
}
...
void SPI_TxFifoInterruptLevelConfig(uint8_t SPI_TX_FIFO_LEV)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CR1_b.TXIFLSEL = SPI_TX_FIFO_LEV;
}
...
void SPI_RxFifoInterruptLevelConfig(uint8_t SPI_RX_FIFO_LEV)
{
  ...
  ((SPI_Type *) 0x40400000UL)->CR1_b.RXIFLSEL = SPI_RX_FIFO_LEV;
}
...
void SPI_DMACmd(uint8_t SPI_DMAReq, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    ((SPI_Type *) 0x40400000UL)->DMACR |= SPI_DMAReq;
  }
  else
  {
    /* Disable the DMA transfer */
    ((SPI_Type *) 0x40400000UL)->DMACR &= (uint8_t)~SPI_DMAReq;
  }
}
